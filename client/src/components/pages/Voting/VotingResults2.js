            ...
            <div className="flex flex-row w-full">
                <div className="w-[50%] px-[5%] flex flex-col align-items justify-between overflow-auto">
                        {prompt["response_0_vote_names"].map((player) => {    
                            return (<div className="bg-silver-300 mx-2 rounded-2xl p-1 flex flex-row w-full align-items justify-start">
                ...
                <div className="w-[50%] px-[5%] flex flex-col align-items justify-between overflow-auto">
                        {prompt["response_1_vote_names"].map((player) => {
                            return (
                                <div className="bg-silver-300 rounded-2xl m-2 p-1 flex flex-row w-full align-items justify-start">
