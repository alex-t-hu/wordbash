        ...
        <div className={`absolute left-[-25%] top-0 w-[150%] h-full justify-center items-center ${props.helpVisible ? "z-[1]" : "z-[-1]"}`}>
           {!props.helpVisible ? 
            <div className=" flex flex-col justify-end w-0 left-8 bottom-8 items-center">
                    <button className="absolute bottom-[-100%] right-[37%] bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow transition ease-in-out delay-50 hover:scale-[1.05] hover:scale-130 duration-300" onClick={()=>{props.setHelpVisible(true)}}>
                    How to play
             ...
             :
          <div className={`absolute left-0 top-[-50%] text-white z-20 `}>
